...
int main()
{
    ...
    char udk[33] = { 0 };
    GenUdk("9EE66BE0F25DA4D308978CDF643BD00D", "62355358600002171F", "01", udk);
	...
	GenSMICCPublicKey(smIssuerPublicKey, smIccPublicCert, needAuthStaticData,"62355358600002171F", smIccPublicKey);
	printf("\nSM ICC Public Key: %s\n", smIccPublicKey);
