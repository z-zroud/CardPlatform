...
public:
	...
	static bool DrawImage(HDC hDC, CPaintManagerUI* pManager, const RECT& rcControl, const RECT& rcPaint, CImageAttribute& image, bool bResize = false);
	...
	static void DrawTriangle(HDC hDC, const POINT &x, const POINT& y, const POINT& z, DWORD dwPenColor, bool bFilled);
